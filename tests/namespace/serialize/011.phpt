...
var_dump(unserialize(pack('H*', 'cd03')));
var_dump(unserialize(pack('H*', '81c0a8737464436c61737320')));
var_dump(unserialize(pack('H*', '81c0da03e8737464436c617373')));
var_dump(unserialize(pack('H*', '8200a2313201')));
var_dump(unserialize(pack('H*', '8200a23132')));
var_dump(unserialize(pack('H*', '8200a2313201da03e8313233')));
var_dump(unserialize(pack('H*', 'da03e8313233')));
var_dump(unserialize(pack('H*', 'a0313233')));
?>
===DONE===
--EXPECTF--
